...
export default function HomePage() {
  const [statsCards, setStatsCards] = useState([
    { title: 'Totais', value: 1327, description: 'germoplasma de café cadastrados', icon: 'Coffee' },
    { title: 'Resistentes à Ferrugem', value: 999, description: 'germoplasma resistentes', icon: 'ThumbsUp' },
    { title: 'Não resistentes à Ferrugem', value: 999, description: 'germoplasma não resistentes', icon: 'ThumbsDown' },
  ])
      ...
      <div className="container mx-auto p-6">
        <div className="rounded-lg bg-white p-6 shadow-sm">
          ...
          <div className="flex flex-col gap-6">
            ...
            <DataTable data={tableData.filter(item =>
...
function AddStatsCardDialog({ onAdd }) {
  const [newCard, setNewCard] = useState({ title: '', value: 0, description: '', icon: 'Coffee' })
      ...
      <DialogContent>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <Input id="icon" value={newCard.icon} onChange={(e) => setNewCard({...newCard, icon: e.target.value})} required />
          </div>
...
function AddTableRowDialog({ onAdd }) {
...
function AddInfoCardDialog({ onAdd }) {
